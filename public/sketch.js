...
function setup() {
  ...
  button.position(50+(25+padding), height-75);
  button.size(25,25);
  button.style("background-color", "#000000");

  button = createButton("");
  button.mousePressed(color2)
  button.position(50+(25+padding), height-50+padding);
  button.size(25,25);
