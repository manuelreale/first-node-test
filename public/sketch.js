...
function centerCanvas() {
  ...
  var y = ((windowHeight - height) / 2)-140;
  cnv.position(x, y);
}
...
windowpaint.position((windowWidth/2)-(width/2)-126, (windowHeight/2)-(height/2)-53-140)
windowpaint.style("pointer-events", "none")


  colPic = createColorPicker(myColor);
  colPic.position((windowWidth/2)-(width/2)+2-75, (windowHeight/2)+(height/2)+90-75-130);
